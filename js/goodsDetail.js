        ...
        $(document).on('change', '.selectType', function () {
           ...
           var benefit_payment_arr_html = '';
            ...
            for (var i = 0; i <= selectChild[0].payment_conditions.length - 1;  i++) {
                ...
                payment_conditions_html += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + selectChild[0].payment_conditions[i][2] + '</span>';
                }
            ...
            for (var  i = 0; i <= selectChild[0].payment_ways.length - 1; i++) {
                ...
                payment_ways_html += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + selectChild[0].payment_conditions[i][2] + '</span>';
                }
        ...
        $(document).on('change', '.selectTypeChild', function () {
           var v = $(this).find("option:selected").val();
            ...
            for (var i = 0; i <= selectChild[v].payment_conditions.length - 1;  i++) {
                ...
                payment_conditions_html += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + selectChild[v].payment_conditions[i][2] + '</span>';
                }
            ...
            for (var i = 0; i <= selectChild[v].payment_ways.length - 1; i++) {
                ...
                payment_ways_html += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + selectChild[v].payment_conditions[i][2] + '</span>';
                }
                ...
                if (data.err_msg == 'INVALID_SESSION_KEY') {
                   ...
                   var benefit_payment_arr_html = '';
                    ...
                    if(company.capital_nationality[2] != ''){
                        info_html += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + company.capital_nationality[2] + '</span>';
                    }
                    info_html += '<span>'+company.capital_nationality[1]+'</span></p>' ;
                    info_html +=  ' <p>' + company.is_listed[0];
                    if(company.is_listed[2] != ''){
                        info_html += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + company.is_listed[2] + '</span>';
                    }
                    info_html +='<span>' + company.is_listed[1] + '</span></p>' ;
                    info_html += '<p>' + company.established_date[0] ;
                    if(company.established_date[2] != ''){
                        info_html += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + company.established_date[2] + '</span>';
                    }
                    ...
                    if(company.website[2] != ''){
                        info_text += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + company.website[2] + '</span>';
                    }
                    ...
                    if(company.hotline[2] != ''){
                        info_text += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + company.hotline[2] + '</span>';
                    }
                    info_text +='<span>' + company.hotline[1] + '</span></p>' ;
                    info_text += '<p>' + company.head_quarter[0] ;
                    if(company.head_quarter[2] != ''){
                        info_text += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + company.head_quarter[2] + '</span>';
                    }
                    ...
                    if(dividend.dividend_way[1] != '--'){
                        ...
                        if(dividend.dividend_way[2] != ''){
                            dividend_info +=  '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + dividend.dividend_way[2] + '</span>';
                        }
                    ...
                    if(dividend.dividend_cycle[1] != '--'){
                        ...
                        if(dividend.dividend_cycle[2] != ''){
                            dividend_info +=  '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + dividend.dividend_cycle[2] + '</span>';
                        }
                    ...
                    if(ability.core_solvency_adequacy_ratio[2]  != ''){
                        solvency +='<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + ability.core_solvency_adequacy_ratio[2] + '</span>';
                    }
                    ...
                    if(ability.comprehansive_solvency_adequacy_ratio[2]  != ''){
                        solvency +='<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + ability.comprehansive_solvency_adequacy_ratio[2] + '</span>';
                    }
                    ...
                    if(ability.solvency_rating[2]  != ''){
                        solvency +='<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + ability.solvency_rating[2] + '</span>';
                    }
                    ...
                    if(strategically.original_insurance_premium_income[2] != ''){
                        market +=  '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + strategically.original_insurance_premium_income[2] + '</span>';
                    }
                    ...
                    if(strategically.investment_new_premium[2] != ''){
                        market +=  '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + strategically.investment_new_premium[2] + '</span>';
                    }
                    ...
                    if(strategically.investment_link_account_new_premium[2] != ''){
                        market +=  '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + strategically.investment_link_account_new_premium[2] + '</span>';
                    }
                    ...
                    if(strategically.original_insurance_premium_income_ranking[2] != ''){
                        market +=  '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + strategically.original_insurance_premium_income_ranking[2] + '</span>';
                    }
                    ...
                    if(strategically.original_insurance_premium_income_market_share[2] != ''){
                        market +=  '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + strategically.original_insurance_premium_income_market_share[2] + '</span>';
                    }
                    ...
                    if(loan.loan_period[1] != '--'){
                        ...
                        if(loan.loan_period[2] != ''){
                            loan_text +=  '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + loan.loan_period[2] + '</span>';
                        }
                    ...
                    if(loan.loan_amount[1] != '--'){
                        ...
                        if(loan.loan_amount[2] != ''){
                            loan_text +=  '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + loan.loan_amount[2] + '</span>';
                        }
                    ...
                    if(loan.loan_interest_rate[1] != '--'){
                        ...
                        if(loan.loan_interest_rate[2] != ''){
                            loan_text +=  '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + loan.loan_interest_rate[2] + '</span>';
                        }
                   ...
                   if(loan_text != ''){
                    ...
                    if(initial_fee.insurance_cancellation_fee[1] != '--'){
                        ...
                        if(initial_fee.insurance_cancellation_fee[2] != ''){
                            initial_fee_html += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + initial_fee.insurance_cancellation_fee[2] + '</span>';
                        }
                    ...
                    if(initial_fee.initial_fee[1] != '--'){
                        ...
                        if(initial_fee.initial_fee[2] != ''){
                            initial_fee_html += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + initial_fee.initial_fee[2] + '</span>';
                        }
                    ...
                    if(initial_fee.insurance_management_fee[1] != '--'){
                        ...
                        if(initial_fee.insurance_management_fee[2] != ''){
                            initial_fee_html += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + initial_fee.insurance_management_fee[2] + '</span>';
                        }
                    ...
                    if(benefit_claim_info.acc_notify_period[1] != '--'){
                        ...
                        if(benefit_claim_info.acc_notify_period[2] != ''){
                            benefit_claim +='<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + benefit_claim_info.acc_notify_period[2] + '</span>';
                        }
                    ...
                    if(benefit_claim_info.benefit_approval_period[1] != '--'){
                        ...
                        if(benefit_claim_info.benefit_approval_period[2] != ''){
                            benefit_claim +='<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + benefit_claim_info.benefit_approval_period[2] + '</span>';
                        }
                    ...
                    if(benefit_claim_info.benefit_delivered_period[1] != '--'){
                        ...
                        if(benefit_claim_info.benefit_delivered_period[2] != ''){
                            benefit_claim +='<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + benefit_claim_info.benefit_delivered_period[2] + '</span>';
                        }
                    ...
                    if(insurance_cancellation_info.cooling_off_period[1] != '--'){
                        ...
                        if(insurance_cancellation_info.cooling_off_period[2] != ''){
                            insurance_cancellation +='<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + insurance_cancellation_info.cooling_off_period[2] + '</span>';
                        }
                    ...
                    if(insurance_cancellation_info.insurance_cancellation_period[1] != '--'){
                        ...
                        if(insurance_cancellation_info.insurance_cancellation_period[2] != ''){
                            insurance_cancellation +='<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + insurance_cancellation_info.insurance_cancellation_period[2] + '</span>';
                        }
                   ...
                   if(insurance_cancellation != ''){
                    ...
                    if(insurance_info.target_audience[2] != ''){
                        insurance_info_html +='<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + insurance_info.target_audience[2] + '</span>';
                    }
                    ...
                    if(insurance_info.policy_period[2] != ''){
                        insurance_info_html +='<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + insurance_info.policy_period[2] + '</span>';
                    }
                    ...
                    if(insurance_info.extra_insurance[2] != ''){
                        insurance_info_html +='<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + insurance_info.extra_insurance[2] + '</span>';
                    }
                    ...
                    if(insurance_info.insurance_age_coverage[2] != ''){
                        extra_insurance_html += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + insurance_info.insurance_age_coverage[2] + '</span>';
                    }
                    ...
                    if(insurance_info.insurance_payment_info[2] != ''){
                        extra_insurance_html += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + insurance_info.insurance_payment_info[2] + '</span>';
                    }
                    ...
                    if(insurance_info.insurance_grace_period[2] != ''){
                        extra_insurance_html += '<img src="https://pics.wanbaolife.com/info.png?v=1" class="mask"><span style="display: none">' + insurance_info.insurance_grace_period[2] + '</span>';
                    }
